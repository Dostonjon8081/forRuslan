...
import uz.fizmasoft.dyhxx.databinding.FragmentSettingsBinding
...
//        binding.accountRate.setOnClickListener { showRateApp() }
    ...
    private fun showLanguages() {
        SettingsLanguageFragment().show(requireActivity().supportFragmentManager, "language")
    }

    private fun aboutApp() {
        getBaseActivity {
            it.navController?.navigate(MainFragmentDirections.actionMainFragmentToAboutFragment())
        }
    }
